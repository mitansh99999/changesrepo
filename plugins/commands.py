...
async def start(client, message):
    ...
    if mc.startswith('verify'):
        ...
        await client.send_message(LOG_CHANNEL, script.VERIFIED_LOG_TEXT.format(message.from_user.mention, message.from_user.id, datetime.now(pytz.timezone('Asia/Kolkata')).strftime('%d %B %Y'), num))
