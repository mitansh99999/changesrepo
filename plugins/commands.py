...
async def start(client, message):
    ...
    if mc.startswith('verify'):
        ...
        await client.send_message(LOG_CHANNEL, script.VERIFIED_LOG_TEXT.format(m.from_user.mention, user_id, dt.now(pytz.timezone('Asia/Kolkata')).strftime('%d %B %Y'), num))
