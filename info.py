...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6131871030:AAHsGGbO5A4nE10dorT5guI7RNF1Ivtt-e4') 
if len(BOT_TOKEN) == 0:
...
SHORTLINK_API = environ.get("SHORTLINK_API", "87866b2192ec34f13170a3e5b572345d31864eab")
